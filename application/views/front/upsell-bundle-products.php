<div class="slider-container">
    ...
    <?php } ?>
                ...
                <img src="<?php echo $this->config->item('upsell_plus'); ?>" alt="more upsell"  height="50" width="50"/>
        <?php }
            } ?>
                <button class="add-upsell-cart">
            <img src="<?php echo $this->config->item('upsell_equal'); ?>" alt="more upsell" height="100" width="100"/>
        </button>
        <?php  }
            ?>
        </div>
