...
//    prExit($editSelectedTargetAry);
    foreach ($prodList as $prod) {
        $idDisabled   = (in_array($prod->product_id, $editSelectedBundleProductAry)) ? ' disabled' : '';
        ...
        ?>
        <div class="copy-prod-cross-sell-<?= $prod->product_id ?>">
            <div class="product-search-item product-item">
                ...
                <div class="search-result-links">
                    <button type="button" data-productid="<?= $prod->product_id ?>" class="copy-cross-product btn btn-add trig-<?= $prod->product_id ?>" <?php echo $idDisabled; ?>>Add</button>
                </div>
            </div>
        </div>
        <?php
