...
class Shopify {
     ...
     * @throws \Exception
     */
    public function call($userData = array(), $verifyData = TRUE, $linkHeaderReturn=false) {
        ...
        /****Get Link header from response headers for pagination*****/
        ...
        if($linkHeaderReturn){
            ...
            if(isset($headers['Link'])){
                ...
                if (strpos($link, 'previous') === false) {
                    ...
                    $nextLink = str_replace('https://','',trim(preg_replace('/[<>;]/s', '', $nextLink)));
                }
            }
            $result->next_link = $nextLink;
        }
